...
ARCHIVE_PATH="$OUT_DIR/baseball-live-kr-macmini-runtime.tar.gz"
...
cp -R "$ROOT_DIR/.build/baseball-live-kr-backend-macos" "$STAGING_DIR/.build/baseball-live-kr-backend-macos"
...
chmod +x "$STAGING_DIR/.build/baseball-live-kr-backend-macos/run-backend.command"
